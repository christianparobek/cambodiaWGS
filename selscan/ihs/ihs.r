## Analyze and plot NORMALIZED iHS data
## Adapted from nsl.r
## Cloned 28 February 2016
## Christian P
...
filenames <- dir(args[1], pattern =".ihs.out.100bins.norm") # ihs data
...
} # read in chr ihs files, add a chr column (padded), and cat together
for(chr in len$V1){
