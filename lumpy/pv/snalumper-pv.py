...
workdir: '/proj/julianog/users/ChristianP/cambodiaWGS/lumpy/pv/'
REF = '/proj/julianog/refs/PvSAL1_v13.0/PlasmoDB-13.0_PvivaxSal1_Genome.fasta'
readWD = '/proj/julianog/users/ChristianP/cambodiaWGS/lumpy/pv/'
SAMPLES, = glob_wildcards('/proj/julianog/users/ChristianP/cambodiaWGS/lumpy/pv/catreads/{sample}_R1.fq.gz')
